...
<div>
  ...
  {
    echo "<table align='center'><tr><th>User ID</th><th>Update User</th></tr>";

    while($row = mysqli_fetch_assoc($result))
    {
      echo "<tr><td>"; echo $row["UserID"];
      echo "</td><td><button type='submit' name=update formaction='promanupdate.php' value='".$row["UserID"]." '>Update</button></td></tr>";
    }
    echo "</table>";
  } 
  ?>
